...
there are some config variables defined in the .env file that can be adjusted; 
* development domain (until there is a final domain name for the server this is some cryptic chost20.zim.something)